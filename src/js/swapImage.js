...
// eventlisteners
butterflysListItem.forEach(link => link.addEventListener('mouseover', swapButterfly));
butterflysListItem.forEach(link => link.addEventListener('mouseout', swapButterfly));
